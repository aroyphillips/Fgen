...
%%% This protocol was written by Roy Phillips 6/8/2021
...
for currentTrial = 1:MaxTrials
    ...
    RewardLocations = [RewardLocationStart, RewardLocationStart+RewardLocationDuration];
    
    Threshold = RewardLocations * Dist2Deg;
