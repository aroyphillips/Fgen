...
// Incoming Bit Stream should look like this: '<p0,2,150,10!t0,2,150,10,20,10!^1,3,100,80,30!g0,2,120,100,10!r0,3,60,10!>'
...
void parsePulseData(char pulse_str[]) {
  ...
  strtokIndx = strtok(NULL, ",");
  pulseDuration = atoi(strtokIndx);

  strtokIndx = strtok(NULL, ",");
  pulseDelay = atoi(strtokIndx);     // convert this part to a float
