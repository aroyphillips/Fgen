...
boolean pulseNow = false; // signal an analog or digital pulse
...
void outputVolts(){
    ...
    if(isTrainActive){
      ...
      if (isTrainDist){
        ...
        // Important to make sure the train ends
        else if (hasSpiked && ((dist>trainEnd))){ // end spike train past distance
