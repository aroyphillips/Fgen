function OptionalOperantFixedReward


%%% Provides animal reward located at user specified location if the animal licks
%%% Assumed lick port is port 1
...
if isempty(fieldnames(S))  % If chosen settings file was an empty struct, populate struct with default settings
    ...
    S.GUI.RewardLocationDuration = 10; %cm
...
%% Update the GUI data
    ...
    RewardLocationDuration = (S.GUI.RewardLocationDuration);
    isOperant = (S.GUI.IsOperant);
    
    R.wrapPoint = 2160; %6 rotations
    
    Thresholds = round([RewardLocationStart, RewardLocationStart+RewardLocationDuration]*Dist2Deg);
    ...
    if isOperant
        fprintf('Reward Location %gcm to %gcm\n', RewardLocationStart, RewardLocationStart+RewardLocationDuration)
    else
