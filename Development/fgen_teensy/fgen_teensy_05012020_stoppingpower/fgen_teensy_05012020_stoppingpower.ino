...
// Incoming Bit Stream should look like this: '<v0,000,000!b0,100,8,0500!p0,2.00,010,7,0150!t0,2.00,050,7,050,8,020,040!a0,2.00,110,7,050,8,020,040!^1,2.50,100,080,030!g0,2,120,100,10!>'
...
void outputVolts(){
    ...
    if isMinVeloActive{
      if ((currTime-pastTime)>veloCheckTime){
...
void parseVeloData(char velo_str[]) {
  ...
  isVeloActive =(*strtokIndx=='1');     // converts char* to a boolean
  ...
  Serial.print(isVeloActive);
  Serial.print(" Minimum Velocity Threshold:");
  Serial.println(minVeloThresh);
  */
}
